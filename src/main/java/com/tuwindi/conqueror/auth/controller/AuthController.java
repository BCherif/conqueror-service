...
import com.tuwindi.conqueror.auth.service.AuthService;
import com.tuwindi.conqueror.auth.wrapper.AuthBody;
...
public class AuthController {
    ...
    public WResponse authenticate(@RequestBody Credentials credentials) {
        log.info("credentials: {}", credentials);
        return WResponse.error("AuthController");
    }*/
}
