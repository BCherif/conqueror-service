package com.tuwindi.conqueror.auth.security;

public class SecurityConstants {
    public static final String AUTH_LOGIN_URL = "/api/auth/login";
    public static final String AUTH_LOGOUT_URL = "/api/auth/logout";
    public static final String FORGET_PWD_LOGOUT_URL = "/api/auth/forget_pwd";
    public static final String USER_SAVE_URL = "/api/users";
